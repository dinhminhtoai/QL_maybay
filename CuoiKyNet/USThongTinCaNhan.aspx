<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="USThongTinCaNhan.aspx.cs" Inherits="CuoiKyNet.USThongTinCaNhan" %>
            ...
            <table>
                ...
                <tr style="text-align:center">
                    <td colspan="2" style="padding-top:20px;">
                         <asp:Button CssClass="button" ID="btncapnhat" runat="server" Text="Cập Nhật" OnClick="btncapnhat_Click" BackColor="#003300"/>
                    </td>
                </tr>
            </table>
        </div>
