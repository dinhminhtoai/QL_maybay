<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="USBanVe.aspx.cs" Inherits="CuoiKyNet.USBanVe" %>
            ...
            <tr style="text-align: center;">
                <td colspan="2">
                    <div style="padding-top:15px">
                        <asp:Button CssClass="button" ID="btnThem" runat="server" Text="Thêm" OnClick="btnThem_Click" BackColor="#FF3300" BorderColor="#FF3300" />
                        <asp:Button CssClass="button" ID="btnLamTrang" runat="server" Text="Làm trắng" OnClick="btnLamTrang_Click" BackColor="#FF3300" />
                    </div>
                </td>
            </tr>
        </table>
