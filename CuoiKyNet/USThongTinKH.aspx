<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="USThongTinKH.aspx.cs" Inherits="CuoiKyNet.USThongTinKH" %>
    ...
    <div style="display: flex; justify-content: center; padding-bottom: 20px;">
            ...
            <tr style="text-align: center;">
                <td colspan="2" style="padding-top:25px">
                    <div style="padding-bottom:20px">
                        <asp:Button CssClass="button" ID="btnThem" runat="server" Text="Thêm" OnClick="btnThem_Click" BackColor="#666633" />
                        <asp:Button CssClass="button" ID="btnSua" runat="server" Text="Cập Nhật" OnClick="btnSua_Click" BackColor="#666633" />
                        <asp:Button CssClass="button" ID="btnXoa" runat="server" Text="Xóa" OnClick="btnXoa_Click" BackColor="#666633" />
                        <asp:Button CssClass="button" ID="btnLamTrang" runat="server" Text="Làm trắng" OnClick="btnLamTrang_Click" BackColor="#666633" />
                    </div>
                </td>
            </tr>
        </table>
        <div style="margin-left:50px; margin-right:50px; width:50%; text-align:center;">
            <div style="padding-bottom:20px;">
                ...
                <asp:Button CssClass="button" ID="btnTim" runat="server" Text="Tìm" OnClick="btnTim_Click" BackColor="Black" />
            </div>
