<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ADThongTinNhanVien.aspx.cs" Inherits="CuoiKyNet.ADThongTinNhanVien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="display: flex; justify-content: center; padding-bottom: 20px; margin-left:50px">
        <table style="width:550px;">
            ...
            <tr>
                <td><b>Password</b></td>
                <td><asp:TextBox CssClass="textbox" ID="txtPassword" runat="server" Enabled="false" Text="new"></asp:TextBox></td>
            </tr>
        ...
        <div style="margin-right:50px; width: 550px; text-align:center;">
            <div style="padding-bottom:20px;">
                ...
                <asp:Button CssClass="button" ID="btnTim" runat="server" Onclick="btnTim_Click" Text="Tìm" BackColor="Red" />
            </div>
